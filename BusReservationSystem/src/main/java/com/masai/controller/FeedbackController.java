...
public class FeedbackController {
	...
	@PutMapping("/update")
	public ResponseEntity<Feedback> updateFeedbackHandler( @jakarta.validation.Valid @RequestBody Feedback feedback,@RequestParam String key) throws FeedbackException,UserException{
